...
namespace PawnShieldMasks {
    static const std::array<Bitboard, 64> calc_white_pawn_shield_masks() {
    ...
    static const std::array<Bitboard, 64> calc_black_pawn_shield_masks() {
    ...
    static const std::array<Bitboard, 64> WhitePawnShieldMasks = PawnShieldMasks::calc_white_pawn_shield_masks();
    static const std::array<Bitboard, 64> BlackPawnShieldMasks = PawnShieldMasks::calc_black_pawn_shield_masks();
}

// int main(){
//     for (int i=0;i<PawnShieldMasks::WhitePawnShieldMasks.size(); i++)
//     {
//         BitboardOperations::print(PawnShieldMasks::WhitePawnShieldMasks[i]);
//         std::cout<<'\n';
//     }
//     std::cout<<'\n';
//     for (int i=0;i<PawnShieldMasks::BlackPawnShieldMasks.size(); i++)
//     {
//         BitboardOperations::print(PawnShieldMasks::BlackPawnShieldMasks[i]);
//         std::cout<<'\n';
//     }
//     return 0;
// }