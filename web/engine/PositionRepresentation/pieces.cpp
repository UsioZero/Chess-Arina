...
Pieces::Pieces(const std::string& short_fen) {
    ...
    for (auto buff : short_fen) {
        if (buff == '/') {
            ...
            switch (buff) {
                case 'p': BitboardOperations::set_1(this->pieceBitboards[side][Pieces::Pawn], y * 8 + x); break;
                case 'n': BitboardOperations::set_1(this->pieceBitboards[side][Pieces::Knight], y * 8 + x); break;
                case 'b': BitboardOperations::set_1(this->pieceBitboards[side][Pieces::Bishop], y * 8 + x); break;
                case 'r': BitboardOperations::set_1(this->pieceBitboards[side][Pieces::Rook], y * 8 + x); break;
                case 'q': BitboardOperations::set_1(this->pieceBitboards[side][Pieces::Queen], y * 8 + x); break;
                case 'k': BitboardOperations::set_1(this->pieceBitboards[side][Pieces::King], y * 8 + x); break;
            }
...
std::ostream &operator<<(std::ostream &ostream, Pieces pieces) {
    ...
    for (int8_t y = 7; y >= 0; y = y - 1) {
        for (uint8_t x = 0; x < 8; x = x + 1) {
            ...
            if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::White][Pieces::Pawn], y * 8 + x)) ostream << "P";
            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::White][Pieces::Knight], y * 8 + x)) ostream << "N";
            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::White][Pieces::Bishop], y * 8 + x)) ostream << "B";
            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::White][Pieces::Rook], y * 8 + x)) ostream << "R";
            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::White][Pieces::Queen], y * 8 + x)) ostream << "Q";
            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::White][Pieces::King], y * 8 + x)) ostream << "K";

            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::Black][Pieces::Pawn], y * 8 + x)) ostream << "p";
            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::Black][Pieces::Knight], y * 8 + x)) ostream << "n";
            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::Black][Pieces::Bishop], y * 8 + x)) ostream << "b";
            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::Black][Pieces::Rook], y * 8 + x)) ostream << "r";
            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::Black][Pieces::Queen], y * 8 + x)) ostream << "q";
            else if (BitboardOperations::get_bit(pieces.pieceBitboards[Pieces::Black][Pieces::King], y * 8 + x)) ostream << "k";
...
bool operator ==(Pieces left, Pieces right) {
    for (uint8_t i = 0; i < 2; i = i + 1) {
        for (uint8_t j = 0; j < 6; j = j + 1) {
            if (left.pieceBitboards[i][j] != right.pieceBitboards[i][j]) return false;
        }
    }
